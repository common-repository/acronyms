...
<?php }
    ...
    if ( 0 == $n ) $t = 1;
    else $t = ceil( Acronyms::acronyms_count( $s ) / $n ); // Total number of pages, rounded up to nearest integer
?>
<div class="wrap">
...
<?php
    ...
    if ( 0 < $n && $page_links ) {
      ...
      $range = $n * ( $p - 1 ) + 1 . '-' . $n * $p;
      $total = Acronyms::acronyms_count( $s );
